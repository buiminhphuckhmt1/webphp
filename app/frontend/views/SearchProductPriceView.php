          ...
          <div class="tabs-container">
            <div class="row" style="margin-top:10px;">
              <div class="head-tabs head-tab1 col-lg-6">
                <h2>
                	Tìm giá từ <?php echo $fromPrice; ?> - đến <?php echo $toPrice; ?>
                </h2>
              </div>
               ...
               <?php foreach($data as $row): ?>
                ...
                <div style="margin-top: -50px;"  class="&#x70;&#x61;&#x67;&#x69;&#x6E;&#x61;&#x74;&#x69;&#x6F;&#x6E;&#x2D;&#x63;&#x6F;&#x6E;&#x74;&#x61;&#x69;&#x6E;&#x65;&#x72;">
                  <ul class="pagination">
                    ...
                    <li class="page-item"><a class="page-link" href="index.php?controller=search&action=searchName&fromPrice=<?php echo $fromPrice; ?>&toPrice=<?php echo $toPrice; ?>&p=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                	<?php endfor; ?>
                  </ul>
                </div>
                <!-- end paging --> 
