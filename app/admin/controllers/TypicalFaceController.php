<?php 
	...
	class TypicalFaceController extends Controller{
		...
		public function index(){
			...
			$this->loadView("TypicalFaceView.php",["data"=>$data,"numPage"=>$numPage]);
		}
		//sua ban ghi - GET
		...
		public function update(){
			...
			$action = "index.php?controller=typicalface&action=updatePost&ID=$id";
			//lay mot ban ghi
			$record = $this->modelGetRecord($id);
			$this->loadView("TypicalFaceFormView.php",["action"=>$action,"record"=>$record]);
		}
		...
		public function updatePost(){
			...
			header("location:index.php?controller=typicalface");
		}
		//them ban ghi
		//url: index.php?controller=news&action=create
		public function create(){
			//tao bien $action de gan vao thuoc tinh action cua the form
			$action = "index.php?controller=typicalface&action=createPost";
			$this->loadView("TypicalFaceFormView.php",["action"=>$action]);
		}
