...
<div class="wrapper">
    ...
    <header class="main-header">
        <!-- Logo -->
        <a href="index.php?controller=home" class="logo">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <a href="index.php?controller=login&action=logoutadmin" class="btn btn-default btn-flat">Sign out</a>
                                </div>
                            </li>
                        </ul>
                    </li>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li>
                    <a href="index.php?controller=login&action=logoutadmin">
