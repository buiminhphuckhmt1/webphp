<?php 
	trait MemberModel{
		...
		public function modelUpdate($id){
			...
			//lay bien ket noi csdl
			$conn = Connection::getInstance();
			$query = $conn->prepare("update member set Stu_Code=:var_Code,Stu_Name=:var_Name,BirthDate=:var_BirthDate,Class=:var_Class,Department=:var_Department,Addresss=:var_Address,Phone=:var_Phone,Email=:var_Email");
			...
			if($_FILES['photo']['name'] != ""){
				...
				//upload anh
				move_uploaded_file($_FILES['photo']['tmp_name'], "../assets/upload/members/$photo");
